/**
 * This is the Board class. The class that initializes the board. This class creates a 9x9 2d array of Piece.
 * To make it easier to read, all the positions with 0 have been ignored. So, b1 is [1][2]. When calling for a piece, it is boardname[rank][file].
 * The file is converted from alphabet to number with a being 1 and h being 8.
